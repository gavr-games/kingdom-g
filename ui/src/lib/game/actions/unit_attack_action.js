...
class UnitAttackAction {
  ...
  cancel() {
    ...
    ActionsController.unitClickChain.remove("attack-unit-click");
    ActionsController.buildingClickChain.remove("attack-building-click");
    EventBus.$emit("unit-deselected", this.unitObserver);
  }
}

export default UnitAttackAction;
