  ...
  <div v-bind:class="['overlay', showRules ? 'active' : '']">
    <div class="landscape-page">
      <div class="rules-container">
        ...
        <div class="rules" v-html="rulesText"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    showRulesWindow() {
      let docsUrl =
        "https://docs.google.com/document/d/e/2PACX-1vQmjG15nRuqi7G6bYktDioWmMiZ83RhrUUTsQQNtOlM_--Z1yGfTJWiyccqAbi1jY00ojdU7yKhDcML/pub?embedded=true";
      if (this.$root.$i18n.locale == "ru") {
        docsUrl =
          "https://docs.google.com/document/d/e/2PACX-1vRDj3PmzPog5luXJ0YT1QQsFLdalN1oPLtSMaOJXimwN4FNLaiu-6elYdkoxozsrLk__XsMBq1k-b4F/pub?embedded=true";
      }
      axios
        .get(docsUrl)
